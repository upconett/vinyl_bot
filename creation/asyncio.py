...
async def make_classic_vinyl(unique_id: int, photo_path: str, audio_path: str, template: int, offset: str, speed: int, noise: bool) -> tuple[str, str]:
    match template:
        case 1: return await mega_run(make_first_plate_vinil, unique_id, photo_path, audio_path, offset, speed, noise)
        case 2: return await mega_run(make_second_plate_vinil, unique_id, photo_path, audio_path, offset, speed, noise)
        case 3: return await mega_run(make_third_plate_vinil, unique_id, photo_path, audio_path, offset, speed, noise)
...
async def make_video_vinyl(unique_id: int, video_path: str, audio_path: str, template: int, offset: str, speed: int, noise: bool) -> tuple[str, str]:
    match template:
        case 1: return await mega_run(make_first_plate_video, unique_id, video_path, audio_path, offset, speed, noise)
        case 2: return await mega_run(make_second_plate_video, unique_id, video_path, audio_path, offset, speed, noise)
        case 3: return await mega_run(make_third_plate_video, unique_id, video_path, audio_path, offset, speed, noise)
...
async def make_player_vinyl(unique_id: int, type: int) -> str:
    ...
    match type:
        case 1: return await mega_run(make_first_player, unique_id, first_cadr_path, video_path)
        case 2: return await mega_run(make_second_player, unique_id, video_path)
        case 3: return await mega_run(make_third_player, unique_id, first_cadr_path, video_path)
